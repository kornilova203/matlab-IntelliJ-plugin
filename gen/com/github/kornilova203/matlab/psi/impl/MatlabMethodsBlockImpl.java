...
public class MatlabMethodsBlockImpl extends MatlabCompositePsiElement implements MatlabMethodsBlock {

  public MatlabMethodsBlockImpl(@NotNull IElementType type) {
    super(type);
  }
