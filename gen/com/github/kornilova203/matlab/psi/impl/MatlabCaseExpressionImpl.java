...
public class MatlabCaseExpressionImpl extends MatlabCompositePsiElement implements MatlabCaseExpression {

  public MatlabCaseExpressionImpl(@NotNull IElementType type) {
    super(type);
  }
