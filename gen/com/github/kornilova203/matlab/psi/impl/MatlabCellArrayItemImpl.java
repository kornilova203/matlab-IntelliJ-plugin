...
public class MatlabCellArrayItemImpl extends MatlabCompositePsiElement implements MatlabCellArrayItem {

  public MatlabCellArrayItemImpl(@NotNull IElementType type) {
    super(type);
  }

  public void accept(@NotNull MatlabVisitor visitor) {
    visitor.visitCellArrayItem(this);
  }
