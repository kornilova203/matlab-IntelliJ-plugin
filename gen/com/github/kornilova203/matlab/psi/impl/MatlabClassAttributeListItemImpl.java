...
public class MatlabClassAttributeListItemImpl extends MatlabCompositePsiElement implements MatlabClassAttributeListItem {

  public MatlabClassAttributeListItemImpl(@NotNull IElementType type) {
    super(type);
  }

  public void accept(@NotNull MatlabVisitor visitor) {
    visitor.visitClassAttributeListItem(this);
  }
