...
public class MatlabUnaryPlusExprImpl extends MatlabBinaryExprImpl implements MatlabUnaryPlusExpr {

  public MatlabUnaryPlusExprImpl(@NotNull IElementType type) {
    super(type);
  }
