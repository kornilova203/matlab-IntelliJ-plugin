...
public class MatlabEnumerationBlockImpl extends MatlabCompositePsiElement implements MatlabEnumerationBlock {

  public MatlabEnumerationBlockImpl(@NotNull IElementType type) {
    super(type);
  }
