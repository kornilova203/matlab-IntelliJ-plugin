...
public class MatlabElseifBlockImpl extends MatlabCompositePsiElement implements MatlabElseifBlock {

  public MatlabElseifBlockImpl(@NotNull IElementType type) {
    super(type);
  }
