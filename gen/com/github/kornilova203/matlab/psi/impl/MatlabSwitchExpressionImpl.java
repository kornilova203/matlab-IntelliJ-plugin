...
public class MatlabSwitchExpressionImpl extends MatlabCompositePsiElement implements MatlabSwitchExpression {

  public MatlabSwitchExpressionImpl(@NotNull IElementType type) {
    super(type);
  }
