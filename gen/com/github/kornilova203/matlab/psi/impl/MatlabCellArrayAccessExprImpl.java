...
public class MatlabCellArrayAccessExprImpl extends MatlabExprImpl implements MatlabCellArrayAccessExpr {

  public MatlabCellArrayAccessExprImpl(@NotNull IElementType type) {
    super(type);
  }

  public void accept(@NotNull MatlabVisitor visitor) {
    visitor.visitCellArrayAccessExpr(this);
  }
